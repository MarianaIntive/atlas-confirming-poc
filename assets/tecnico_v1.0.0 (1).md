...
- **ABM Usuarios:** se elimina columna **Acceso**; el estado **Bloqueado** se muestra en la columna **Estado**.
...
- **ABM Ver detalle EGP/Proveedor:** se quita el campo **Estado de acceso** del modal; permanece **Estado de autorización**.
